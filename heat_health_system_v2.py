...
timestamp as an anonymous but stable series only a                                                                                                                                  ter validating that:
...
try:
    ...
    sys.modules['sklearn._loss'] = sklearn._loss._loss
    sys.modules['_loss'] = sklearn._loss._loss
    sys.modules['_loss.loss'] = sklearn._loss._loss
except Exception:
    pass
